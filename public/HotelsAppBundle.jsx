...
var HotelsApp = function (_Component) {
	_inherits(HotelsApp, _Component);

	function HotelsApp() {
		_classCallCheck(this, HotelsApp);

		var _this = _possibleConstructorReturn(this, (HotelsApp.__proto__ || Object.getPrototypeOf(HotelsApp)).call(this));

		_this.state = {};
		return _this;
	}

	_createClass(HotelsApp, [{
		key: "render",
